...
```
cd existing_repo
git remote add origin https://gitlab.com/kephothosolutions/konverse.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/kephothosolutions/konverse/-/settings/integrations)
